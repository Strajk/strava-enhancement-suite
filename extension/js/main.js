...
if (typeof window.StravaEnhancementSuite === 'undefined') {
    ...
    $.option('submit_forms_with_keyboard', function () {
      ...
      if (/^\/activities\/\d+\/edit$/.test(window.location.pathname)) {
        bind([
          ...
          '#edit-activity #activity_description', // legacy
          '#edit-activity [data-react-class="ActivityDescriptionEdit"] textarea',
          '#edit-activity textarea.private-note',
        ], el => {
  ...
  window.StravaEnhancementSuite = StravaEnhancementSuite;
  window.StravaEnhancementSuiteHelpers = StravaEnhancementSuiteHelpers;
